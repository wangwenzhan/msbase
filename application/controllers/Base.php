...
class Base extends CI_Controller {
    ...
    public function index()
    {
        if (($_SERVER['PHP_AUTH_USER'] == 'belstar') && ($_SERVER['PHP_AUTH_PW'] == '20161122')) {
            ...
            $config['functions']['get_config'] = array('function' => 'Base.get_config');
            $config['functions']['modify_config'] = array('function' => 'Base.modify_config');
...
*/
    ...
    public function set_password($request){
        ...
        $result=$this->base_m->set_password($paras[0],$paras[1],$paras[2]);
